...
export default function PeptideCalculator() {
  ...
  const [mode, setMode] = useState<'units' | 'water'>('units');
    ...
    <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
      <div className="xl:col-span-5 space-y-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-6">
          ...
          <CalculatorInput
            label={mode === 'units' ? "Desired Dose" : "Desired Dose per Injection"}
            value={desiredDose}
          ...
          <div className="w-full max-w-md mx-auto relative mb-6">
            ...
            <div className="relative w-full h-24 flex items-center">
              ...
              <div className="flex-1 h-20 border-y-2 border-l-2 border-gray-400 rounded-l-lg rounded-r-sm relative bg-white/90 overflow-hidden shadow-inner flex items-center">
                {/* Liquid Fill */}
                <div 
                  className="absolute top-0 left-0 bottom-0 bg-blue-400/30 transition-all duration-700 ease-in-out border-r-4 border-blue-500/80 shadow-[inset_0_0_10px_rgba(59,130,246,0.3)]"
