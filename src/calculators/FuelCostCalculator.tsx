...
export default function FuelCostCalculator() {
  ...
  return (
    <div className="max-w-md mx-auto space-y-6">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Gas Price ($ per gallon)</label>
      ...
      <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 text-center mt-8">
        ...
        <div className="text-5xl font-extrabold text-blue-900">${cost.toFixed(2)}</div>
